...
declare module 'react-inspector' {
  ...
  export class ObjectInspector extends React.Component<ObjectInspector.IProperties> {
  }
  ...
  export class TableInspector extends React.Component<ObjectInspector.IProperties, ObjectInspector.IState> {
  ...
  export function Inspector(props: Partial<Inspector.IProperties>): ObjectInspector | TableInspector | DOMInspector;
  ...
  export function ObjectLabel(props: Partial<ObjectLabel.IProperties>): React.ReactElement<ObjectLabel.IProperties>;
  ...
  export function ObjectRootLabel(props: Partial<ObjectRootLabel.IProperties>): React.ReactElement<ObjectRootLabel.IProperties>;
  ...
  export function ObjectName(props: Partial<ObjectName.IProperties>, contexts: Partial<ObjectName.IContexts>): React.ReactElement<ObjectName.IProperties>;
  ...
  export function ObjectValue(props: Partial<ObjectValue.IProperties>, contexts: Partial<ObjectValue.IContexts>): React.ReactElement<ObjectValue.IProperties>;
